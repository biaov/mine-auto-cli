export default {
  // /config
  'Auto-compact': '自动压缩',
  'Switch models when a message is flagged': '当消息被标记时切换模型',
  'Show tips': '显示提示',
  ...
  'Dynamic workflow size': '动态工作流大小',
  'Default permission mode': '默认权限模式',
  'Worktree base ref': '工作树基础引用',
  'Use auto mode during plan': '在计划中使用自动模式',
  'Respect .gitignore in file picker': '文件选择器中遵守 .gitignore 规则',
  'Skip the /copy picker': '跳过 /copy 选择器',
  'Open agents view by default': '默认打开智能体视图',
  'opens agents': '打开智能体',
  ...
  Language: '语言',
  'Editor mode': '编辑器模式',
  'Question auto-continue timeout': '问题自动继续超时时间',
  'Show last response in external editor': '在外部编辑器中显示最后一条回复',
  Model: '模型',
  'Diff tool': '差异工具',
